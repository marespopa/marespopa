---
title: "How AI text detectors work"
description: "How can you decide if a text is AI or not. Or not."
pubDate: 2024-01-25
---
...
Even if it is hard to believe, humans love shortcuts. Why waste a couple of hours trying to write a good article, when you can just feed a prompt to Chat GPT (to be read GiPiTi) and it’ll do all the magic.
...
Therefore all involved in its development process need to work on creating even more cutting-edge and accurate tools that can keep up. Detecting false information created by AI accurately is vital for maintaining online information credibility, which will be the only way to counter these threats effectively.
