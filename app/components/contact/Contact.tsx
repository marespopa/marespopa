...
const buttonAltStyle = `inline-block px-6 my-4 py-2.5 bg-gray-700
text-white font-medium text-xl leading-tight
rounded shadow-md hover:bg-gray-900 hover:shadow-lg
focus:bg-gray-900 focus:shadow-lg focus:outline-none
focus:ring-0 active:bg-gray-800 active:shadow-lg transition
duration-150 ease-in-out`
