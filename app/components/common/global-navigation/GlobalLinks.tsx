...
const menuItemStyle =
  'text-white hover:transition-all duration-150 ease-in-out md:hover:text-fuchsia-300 md:focus:text-fuchsia-300 hover:underline focus:underline'

const linkStyle =
  'px-4 py-2 rounded md:py-0 md:px-0 bg-fuchsia-700 hover:bg-fuchsia-800 md:hover:bg-transparent md:bg-transparent flex items-center text-sm font-medium text-center capitalize hover:transition-all duration-150 ease-in-out'
