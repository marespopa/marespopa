...
function Header() {
  return (
    <header className="w-full border-b-3 border-gray-200 bg-blue-500  text-white">
      <nav className="container mx-auto flex flex-wrap items-center justify-between mt-0 py-2 px-2 md:px-4">
        <Link href="/">Mares Popa</Link>
        <button
